...
class GoogleAuth(GenericAPIView):
    ...
    @swagger_auto_schema(
        ...
        responses={200: GoogleAuthSerializer, 400: "errors"},
    )
...
class RegisterWithEmail(APIView):
    @swagger_auto_schema(
        ...
        responses={200: MyuserEmailSerializer, 400: "errors"},
    )
    def post(self, request):
        print("hoyyaaa")
    ...
    def post(self, request):
        ...
        if serilaizer.is_valid():
            ...
            try:
                ...
                return Response(
                    {"v_id": hashed_otp, "msg": "Otp sent successfully..."},
                    status=status.HTTP_200_OK,
                )
            except Exception as e:
                return Response(
                    {"msg": "Cant sent otp, Please try after sometimes..."},
    ...
    def post(self, request):
        ...
        try:
            ...
            if verify_status == "approved":
                ...
                return Response(
                    {"msg": "Wrong otp..."}, status=status.HTTP_400_BAD_REQUEST
                )
        except Exception as e:
            print(e)
            return Response(
                {"msg": "Somrthing wrong..."}, status=status.HTTP_400_BAD_REQUEST
            )
